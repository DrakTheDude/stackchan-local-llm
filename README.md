...
| **[Reading the server's logs](docs/server-logs.md)** | it logs in Chinese, and this is the glossary — including the one line that tells you your memory summariser is still local |
