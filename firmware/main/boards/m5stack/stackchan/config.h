...
#define CAMERA_PIN_XCLK  GPIO_NUM_NC // pixel clock: supplied by a fixed 20 MHz external crystal
#define CAMERA_PIN_SIOD GPIO_NUM_NC  // SCCB: uses the existing I2C port
#define CAMERA_PIN_SIOC GPIO_NUM_NC  // SCCB: uses the existing I2C port
